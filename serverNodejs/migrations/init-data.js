...
function makeName() {
  let lastName= ['Nguyễn', 'Lê', 'Đào', 'Hồ', 'Trân', 'Đỗ', 'Lý', 'Ninh', 'Cao', 'Trương']
  let fisrtName= 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'
  let middleNam= ['Văn', 'Thị', 'Bá', 'Việt', 'Thu']
...
function makeArea() {
  let District= ['Cẩm Lệ', 'Liên Chiểu', 'Thanh Khê', 'Hải Châu', 'Ngũ Hành Sơn', 'Sơn Trà']
